...
public class GroupRepository : IGroupRepository
{
    ...
    public async Task<List<Group>> GetPlayerGroupsAsync(int playerId)
    {
    ...
    public async Task<List<PlayerGroup>> GetGroupMembersAsync(int groupId)
    {
        return await _context.PlayerGroups
    ...
    public async Task<List<GroupchatMessage>> GetGroupMessagesAsync(int groupId)
    {
